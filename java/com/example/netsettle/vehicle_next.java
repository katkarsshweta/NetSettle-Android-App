...
public class vehicle_next extends AppCompatActivity {
String pno;
    String selectedDate;
    String selectedTime;
...
String vremark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_next);

      selectFileButton = findViewById(R.id.button3);
                                ...
                                .addOnSuccessListener(taskSnapshot -> {
                                    ...
                                    fileRef.getDownloadUrl().addOnSuccessListener(downloadUri -> {
                                       ...
                                       downloadUrl = downloadUri.toString();
                                        DatabaseReference currentUserExtraRef = usersRef.child(pno).child("asset").child("vehicles");
...
//        });
        ...
        selectDateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(vehicle_next.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(android.widget.DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                // Set the selected date to your variables
                                vehicle_next.this.year = year;
                                month = monthOfYear;
                                day = dayOfMonth;
        ...
        selectTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(vehicle_next.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(android.widget.TimePicker view, int hourOfDay, int minute) {
                                // Set the selected time to your variables
                                hour = hourOfDay;
                                vehicle_next.this.minute = minute;
    ...
    public void add(View view) {
        ...
        Intent i = new Intent(vehicle_next.this,vehicle.class);
        startActivity(i);
    }
