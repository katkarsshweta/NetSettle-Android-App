...
public class ornament_next extends AppCompatActivity {
    String pno;
    String selectedDate;
    String selectedTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ornament_next);
                        ...
                        fileRef.putFile(uri)
                                .addOnSuccessListener(taskSnapshot -> {
                                    ...
                                    fileRef.getDownloadUrl().addOnSuccessListener(downloadUri -> {
                                        ...
                                        DatabaseReference currentUserExtraRef = usersRef.child(pno).child("asset").child("ornaments");
...
//                                });
        ...
        selectDateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(ornament_next.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(android.widget.DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                // Set the selected date to your variables
                                ornament_next.this.year = year;
                                month = monthOfYear;
                                day = dayOfMonth;
        ...
        selectTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(ornament_next.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(android.widget.TimePicker view, int hourOfDay, int minute) {
                                // Set the selected time to your variables
                                hour = hourOfDay;
                                ornament_next.this.minute = minute;
    ...
    public void add(View view) {
        ...
        Intent i = new Intent(ornament_next.this,ornament.class);
        startActivity(i);
    }
