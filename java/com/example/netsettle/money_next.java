...
public class money_next extends AppCompatActivity {
    String pno;
    String selectedDate;
    String selectedTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_money_next);
                        ...
                        fileRef.putFile(uri)
                                .addOnSuccessListener(taskSnapshot -> {
                                    ...
                                    fileRef.getDownloadUrl().addOnSuccessListener(downloadUri -> {
                                        ...
                                        DatabaseReference currentUserExtraRef = usersRef.child(pno).child("asset").child("money");
...
//        });
        ...
        selectDateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(money_next.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(android.widget.DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                // Set the selected date to your variables
                                money_next.this.year = year;
                                month = monthOfYear;
                                day = dayOfMonth;
        ...
        selectTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(money_next.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(android.widget.TimePicker view, int hourOfDay, int minute) {
                                // Set the selected time to your variables
                                hour = hourOfDay;
                                money_next.this.minute = minute;
        ...
        categorySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
               ...
               selectedCategoryMode = parentView.getItemAtPosition(position).toString();
    ...
    public void add(View view) {
        ...
        currentUserExtraRef.child(vname).child("document").setValue(downloadUrl);
        currentUserExtraRef.child(vname).child("Type").setValue(selectedCategoryMode);
        ...
        Intent i = new Intent(money_next.this,money.class);
        startActivity(i);
    }
