...
public final class ProfileBinding implements ViewBinding {
  ...
  private ProfileBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull ImageView imageView, @NonNull TextView textView10, @NonNull TextView textView11,
  ...
  public static ProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProfileBinding((ConstraintLayout) rootView, button, imageView, textView10,
